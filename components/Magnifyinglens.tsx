...
export function LensDemoThird() {
  ...
  return (
    <div>
      <Lens>
        <div className="w-full h-30 relative rounded-xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318]">
          {/* <Rays />
          <Beams /> */}
          <div className="relative w-full h-30 rounded-xl overflow-hidden">
            <Image src="/pfp.jpg" alt="image" fill className="object-cover" />
          </div>
        </div>
      </Lens>
    </div>
